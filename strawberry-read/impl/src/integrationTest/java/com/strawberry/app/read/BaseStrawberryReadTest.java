...
public abstract class BaseStrawberryReadTest {

  protected ObjectMapper objectMapper = new ObjectMapper()
      .findAndRegisterModules()
      .disable(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS);

  protected String stateDir = "build/tmp/persistence";
  protected String prismaUrl = "http://localhost:0000/";

  protected StrawberryReadApplicationProperties applicationProperties = new StrawberryReadApplicationProperties(prismaUrl, stateDir);
